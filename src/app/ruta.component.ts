    ...
    mostrarGrillaRuta(){
      ...
      for(let ruta of this.rutas ){
        ...
        this.rutasPresentar.push(
          {
            RuId: ruta.RuId, RuDescripcion: ruta.RuDescripcion, RuFechaCreacion: ruta.RuFechaCreacion,
                    RuKilometro: ruta.RuKilometro, EmConsorcio: ruta.EmConsorcio, EmTipo: _valorTipo
